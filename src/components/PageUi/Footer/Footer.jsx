...
function Footer() {
  return (
    <section
      className="bg-gray-900 overflow-hidden font-custom"
      style={ { backgroundImage: `url(${bgPattern})`, backgroundPosition: 'center' } }
    >
          ...
          <div className="w-full md:w-3/4 lg:flex-1 px-4">
            <div className="flex flex-wrap justify-end -mx-3 lg:-mx-6">
              {navs.map(({ text, link }, index) => (
                <div key={ `footer-nav-${index}` } className="w-full md:w-auto p-3 md:py-0 md:px-6">
                  <a
                    className="inline-block text-lg md:text-xl text-gray-400 hover:text-gray-500 font-medium"
                    href={ link }
                  >
                    {text}
                  </a>
      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap items-center py-12 md:pb-32">
          <div className="w-full md:w-1/2 mb-6 md:mb-0">
            <p className="text-gray-400 font-medium">Copyright © 2023 Chob - All Rights Reserved.</p>
          </div>
          <div className="w-full md:w-1/2">
            <div className="flex flex-wrap md:justify-end -mx-5">
              <div className="px-5">
                <a className="inline-block text-gray-300 hover:text-gray-400" href="/">
                  <svg
                    width="10"
                    height="18"
                    viewBox="0 0 10 18"
